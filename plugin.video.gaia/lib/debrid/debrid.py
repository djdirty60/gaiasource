	...
	def providers(self):
		return [
			...
			},
			{
				'id' : 'realdebrid',
				'name' : 33567,
				'description' : 'RealDebrid is one of the oldest debrid services around. Although their customer support and API design is lacking, they offer good value for money. RealDebrid has a large torrent cache.',
			...
			},
			{
				'id' : 'debridlink',
				'name' : 35263,
				'description' : 'DebridLink is an overall good service and has great value for money. Although not natively supported in Gaia, most functionality can be utilized through external addons. DebridLink is good choice if you are on a budget and want a service with a decent cache.',

				'general' : {'rating' : 5,  'recommend' : 2, 'native' : False, 'limit' : False},
				'subscription' : {'rating' : 5, 'fee' : 2.80},
				'customer' : {'rating' : 5, 'label' : 36247},
				'api' : {'rating' : 5, 'label' : 36244},
				'network' : {'rating' : 4, 'support' : {'torrent' : True, 'usenet' : False, 'hoster' : True}},
				'stream' : {'rating' : 5, 'support' : {'gaia' : False, 'orion' : True, 'resolver' : True}},
				'cache' : {'rating' : 4, 'label' : 36251, 'support' : {'gaia' : False, 'orion' : True, 'resolver' : True}},
			...
			},
			{
				'id' : 'alldebrid',
				'name' : 33568,
				'description' : 'AllDebrid is an overall good service and has great value for money. The API is very poorly designed by uploading torrents to file hosters before streaming from there. Although not natively supported in Gaia, most functionality can be utilized through external addons. AllDebrid is good choice if you are on a budget and want a service with a decent cache.',
