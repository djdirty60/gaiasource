...
#. If you're using requests directly, you can use code like:
   ...
   .. code-block:: python
       ...
       >>> import ssl
       >>> import externals.requests as requests.packages.urllib3.contrib.appengine as ul_appengine
       >>> from externals.requests_toolbelt.adapters import appengine
       >>> s = requests.Session()
...
from externals.requests import sessions
