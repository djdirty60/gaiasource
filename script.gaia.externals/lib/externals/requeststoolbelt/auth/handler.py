...
from externals.requests.auth import AuthBase, HTTPBasicAuth
...
class AuthHandler(AuthBase):
    ...
    .. code-block:: python
        ...
        from externals.requests import HTTPDigestAuth
        from externals.requests_toolbelt.auth.handler import AuthHandler
