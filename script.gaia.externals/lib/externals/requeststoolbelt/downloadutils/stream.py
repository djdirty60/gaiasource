...
def get_download_file_path(response, path):
    ...
    :param response: A Response object from externals.requests
...
def stream_response_to_file(response, path=None, chunksize=_DEFAULT_CHUNKSIZE):
    ...
    .. code-block:: python
        ...
        from externals.requests_toolbelt import exceptions
        from externals.requests_toolbelt.downloadutils import stream
