...
from externals.hachoir.field import (Field, FieldSet, createOrphanField,
                           NullBits, Bit, Bits, Enum, Fragment, MissingField, ParserError,
                           UInt8, UInt16, UInt24, UInt32, UInt64,
                           RawBytes, String, PascalString32, NullBytes)
from externals.hachoir.stream import FragmentedStream, InputStreamError
from externals.hachoir.core.endian import LITTLE_ENDIAN, BIG_ENDIAN
from externals.hachoir.core.tools import humanDurationNanosec
