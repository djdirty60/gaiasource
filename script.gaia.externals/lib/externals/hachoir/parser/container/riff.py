...
from externals.hachoir.field import (FieldSet, ParserError,
                           ...
                           SubFile)
from externals.hachoir.core.tools import alignValue, humanDuration
from externals.hachoir.core.endian import LITTLE_ENDIAN
from externals.hachoir.core.text_handler import filesizeHandler, textHandler
from externals.hachoir.parser.video.fourcc import audio_codec_name, video_fourcc_name
from externals.hachoir.parser.image.ico import IcoFile
