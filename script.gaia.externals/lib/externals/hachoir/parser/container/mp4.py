...
from externals.hachoir.field import (ParserError, FieldSet, MissingField,
                           Enum,
                           ...
                           RawBytes, NullBytes)
from externals.hachoir.field.timestamp import timestampFactory
from externals.hachoir.core.endian import BIG_ENDIAN
from externals.hachoir.core.text_handler import textHandler

from externals.hachoir.core.tools import MAC_TIMESTAMP_T0, timedelta
