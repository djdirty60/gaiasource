...
from externals.hachoir.field import (FieldSet, Link,
...
from externals.hachoir.core.iso639 import ISO639_2
from externals.hachoir.core.tools import humanDatetime
from externals.hachoir.core.text_handler import textHandler, hexadecimal
from externals.hachoir.parser.container.ogg import XiphInt
