...
from externals.hachoir.field import (StaticFieldSet, FieldSet,
                           Bit, RawBits, Bits,
...
from externals.hachoir.core.text_handler import textHandler, filesizeHandler, hexadecimal
from externals.hachoir.parser.audio.modplug import ParseModplugMetadata
from externals.hachoir.parser.common.tracker import NOTE_NAME
