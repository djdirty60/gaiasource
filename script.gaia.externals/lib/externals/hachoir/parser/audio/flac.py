...
from externals.hachoir.field import FieldSet, String, Bit, Bits, UInt16, UInt24, RawBytes, Enum, NullBytes
from externals.hachoir.stream import BIG_ENDIAN, LITTLE_ENDIAN
from externals.hachoir.core.tools import createDict
from externals.hachoir.parser.container.ogg import parseVorbisComment
