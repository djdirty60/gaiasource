...
from externals.hachoir.parser import HachoirParser, Parser
from externals.hachoir.field import (RootSeekableFieldSet, SeekableFieldSet, FieldSet, ParserError,
...
from externals.hachoir.core.tools import (humanDuration, humanFilesize)
