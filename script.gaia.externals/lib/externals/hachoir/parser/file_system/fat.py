...
from externals.hachoir.field import (FieldSet, StaticFieldSet,
                           RawBytes, PaddingBytes, createPaddingField, Link, Fragment,
                           Bit, Bits, UInt8, UInt16, UInt32,
                           String, Bytes, NullBytes)
from externals.hachoir.field.integer import GenericInteger
...
from externals.hachoir.core.tools import humanFilesize, makePrintable
import datetime
import re
