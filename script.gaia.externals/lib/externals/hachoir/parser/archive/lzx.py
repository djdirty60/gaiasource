...
from externals.hachoir.core.endian import MIDDLE_ENDIAN, LITTLE_ENDIAN
from externals.hachoir.core.tools import paddingSize
from externals.hachoir.parser.archive.zlib import build_tree, HuffmanCode, extend_data
