...
from externals.hachoir.core.tools import paddingSize
from externals.hachoir.stream import StringInputStream
from externals.hachoir.parser.archive.lzx import LZXStream, lzx_decompress
from externals.hachoir.parser.archive.zlib import DeflateBlock
