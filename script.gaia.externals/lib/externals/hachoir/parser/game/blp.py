...
from externals.hachoir.field import String, UInt32, UInt8, Enum, FieldSet, RawBytes, GenericVector, Bit, Bits
from externals.hachoir.parser.parser import Parser
from externals.hachoir.parser.image.common import PaletteRGBA
