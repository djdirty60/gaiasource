...
from externals.hachoir.field import (FieldSet, ParserError, Enum,
...
from externals.hachoir.core.tools import createDict, paddingSize, alignValue, makePrintable
from externals.hachoir.parser.common.win32 import BitmapInfoHeader
