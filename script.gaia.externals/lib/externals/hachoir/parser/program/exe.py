...
from externals.hachoir.field import (FieldSet, RootSeekableFieldSet,
                           UInt16, UInt32, String,
                           RawBytes, PaddingBytes)
from externals.hachoir.core.text_handler import textHandler, hexadecimal
from externals.hachoir.parser.program.exe_ne import NE_Header
from externals.hachoir.parser.program.exe_pe import PE_Header, PE_OptHeader, SectionHeader
from externals.hachoir.parser.program.exe_res import PE_Resource, NE_VersionInfoNode
