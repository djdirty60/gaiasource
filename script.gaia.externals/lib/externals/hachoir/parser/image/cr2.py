...
from externals.hachoir.field import SeekableFieldSet, RootSeekableFieldSet, Bytes, String, UInt8, UInt16, UInt32
...
from externals.hachoir.parser.image.exif import IFD, IFD_TAGS
