...
from externals.hachoir.core.tools import humanDuration, paddingSize
from externals.hachoir.core.text_handler import textHandler, displayHandler, hexadecimal
