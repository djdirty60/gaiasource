...
from externals.hachoir.field import (FieldSet, ParserError, FieldError,
                           UInt8, UInt16, Enum, Field,
                           Bit, Bits, NullBits, NullBytes, PaddingBits,
                           String, RawBytes)
from externals.hachoir.parser.image.common import PaletteRGB
...
from externals.hachoir.parser.image.exif import Exif
from externals.hachoir.parser.image.photoshop_metadata import PhotoshopMetadata
from externals.hachoir.parser.archive.zlib import build_tree
from externals.hachoir.core.tools import paddingSize, alignValue
