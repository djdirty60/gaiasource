from externals.hachoir.core.i18n import getTerminalCharset
from externals.hachoir.core.tools import humanFilesize, humanBitSize, makePrintable
from externals.hachoir.core.log import log as hachoir_log
from externals.hachoir.core.cmd_line import getHachoirOptions, configureHachoir
from externals.hachoir.core.cmd_line import displayVersion

from externals.hachoir.field import Field, MissingField
from externals.hachoir.stream import InputFieldStream, InputStreamError, FileInputStream
from externals.hachoir.parser import guessParser, HachoirParserList
...
def profile(func, *args):
    from externals.hachoir.core.profiler import runProfiler
