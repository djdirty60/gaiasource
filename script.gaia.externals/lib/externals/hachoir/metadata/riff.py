...
from externals.hachoir.metadata.metadata import (Metadata, MultipleMetadata,
                                       registerExtractor)
from externals.hachoir.metadata.safe import fault_tolerant, getValue
from externals.hachoir.parser.container.riff import RiffFile
from externals.hachoir.parser.video.fourcc import UNCOMPRESSED_AUDIO
from externals.hachoir.core.tools import humanFilesize, makeUnicode, timedelta2seconds
from externals.hachoir.metadata.audio import computeComprRate as computeAudioComprRate
