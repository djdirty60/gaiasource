from externals.hachoir.metadata.metadata_item import QUALITY_BEST, QUALITY_FASTEST
from externals.hachoir.metadata.safe import fault_tolerant, getValue
from externals.hachoir.metadata.metadata import (
    RootMetadata, Metadata, MultipleMetadata, registerExtractor)
from externals.hachoir.parser.archive import (Bzip2Parser, CabFile, GzipParser,
                                    TarFile, ZipFile, MarFile)
from externals.hachoir.core.tools import humanUnixAttributes
