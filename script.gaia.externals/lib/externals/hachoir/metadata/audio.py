from externals.hachoir.metadata.metadata import (registerExtractor, Metadata,
                                       RootMetadata, MultipleMetadata)
from externals.hachoir.parser.audio import (AuFile, MpegAudioFile, RealAudioFile,
                                  AiffFile, FlacParser)
from externals.hachoir.parser.container import OggFile, RealMediaFile
from externals.hachoir.core.tools import makePrintable, timedelta2seconds, humanBitRate
from datetime import timedelta
from externals.hachoir.metadata.metadata_item import (QUALITY_FAST, QUALITY_NORMAL,
                                            QUALITY_BEST)
from externals.hachoir.metadata.safe import fault_tolerant, getValue
