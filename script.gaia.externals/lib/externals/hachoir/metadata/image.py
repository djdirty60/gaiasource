...
from externals.hachoir.parser.image import (
    BmpFile, IcoFile, PcxFile, GifFile, PngFile, TiffFile,
    XcfFile, TargaFile, WMF_File, PsdFile)
from externals.hachoir.parser.image.png import getBitsPerPixel as pngBitsPerPixel
from externals.hachoir.parser.image.xcf import XcfProperty
