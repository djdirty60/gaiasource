from externals.hachoir.field import Bytes
from externals.hachoir.core.tools import makePrintable, humanFilesize
from externals.hachoir.stream import InputIOStream
